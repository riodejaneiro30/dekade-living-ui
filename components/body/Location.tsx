...
export default function Location() {
  const nearbyPlaces = [
    ...
    { icon: "domain", name: "Kantor Otoritas Jasa Keuangan", distance: "700 m" },
    { icon: "school", name: "IPB International", distance: "700 m" },
    { icon: "local_hospital", name: "RSU Puri Raharja", distance: "1 km" },
    { icon: "local_police", name: "Polda Bali", distance: "1 km" },
    { icon: "school", name: "Universitas Mahasaraswati", distance: "1.2 km" },
    { icon: "school", name: "Universitas Bali International", distance: "1.3 km" },
    { icon: "domain", name: "Dharma Negara Alaya (DNA)", distance: "2 km" },
    { icon: "beach_access", name: "Pantai Sanur", distance: "7 km" },
  ];
  ...
  return (
    <section id="location" className="bg-white py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="w-full h-[420px] rounded-2xl overflow-hidden shadow-lg mb-12">
          <iframe
